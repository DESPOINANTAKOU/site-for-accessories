...
";
    ...
    {
        return new Source("", "emails/newSubscriberNotification.txt", "/var/www/vhosts/wipesnmore.gr/TAGaccessorize/wp-content/plugins/mailpoet/views/emails/newSubscriberNotification.txt");
    }
}
